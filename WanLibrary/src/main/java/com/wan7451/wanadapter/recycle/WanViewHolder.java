...
public class WanViewHolder extends RecyclerView.ViewHolder {
        ...
        if (adapter.getItemClickListener() != null) {
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(adapter.getItemClickListener()!=null)
                    adapter.getItemClickListener().onItemClickListener(getAdapterPosition() - adapter.getHeaderViewsCount(), WanViewHolder.this);
                }
            });
        }
    ...
    public int getCurrPosition() {
        return getAdapterPosition() - adapter.getHeaderViewsCount();
    }
