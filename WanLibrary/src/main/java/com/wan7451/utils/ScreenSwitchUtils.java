...
//            mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
    ...
    private OnOrientationChangeListener l;

    public void setOnOrientationChangeListener(OnOrientationChangeListener l) {
        this.l = l;
    }
