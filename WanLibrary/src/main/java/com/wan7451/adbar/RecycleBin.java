...
public class RecycleBin {
     ...
     */
    private SparseArray<View>[] scrapViews;  //用于缓存不同类型的不同View

    private int viewTypeCount;

    private SparseArray<View> currentScrapViews; //当前缓存的碎片View
    ...
    public void setViewTypeCount(int viewTypeCount) {
        ...
        //碎片View数组，数据长度为View类型，一个数组下标保存一种类型的View对象
