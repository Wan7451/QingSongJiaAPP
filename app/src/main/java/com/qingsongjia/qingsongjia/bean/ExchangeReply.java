...
//    private String dri_reply_type;// 内容类别 0：所发表文章 1：文章回复 2：文章回复的子回复
//    private String dri_reply_id;// 用于绑定回复所对应的父类，若为所发表文章值为-1
     ...
     * create_id : 0
     * create_nm :
     * create_tm : {"date":27,"day":0,"hours":16,"minutes":1,"month":11,"nanos":0,"seconds":12,"time":1451203272000,"timezoneOffset":-480,"year":115}
     * create_tm_str : 2015-12-27 16:01:12
     * did : 296
     * dri_campus_id : 0
     * dri_eaa_state : 0
     * dri_eaa_state_nm : 未审批
     * dri_fx_campus_id : 0
     * dri_image_url :
     * dri_reply_id : 295
     * dri_reply_type : 1
     ...
     * update_id : 0
     * update_nm :
     * update_tm : {"date":27,"day":0,"hours":16,"minutes":1,"month":11,"nanos":0,"seconds":12,"time":1451203272000,"timezoneOffset":-480,"year":115}
     * update_tm_str : 2015-12-27 16:01:12
     * user_file :
     */
    ...
    public void setDri_reply_id(int dri_reply_id) {
